 ...
 * @LastEditTime: 2023-04-19 16:28:16
 * @FilePath: \webgpu\WebGPU\examples\textureTest.ts
...
var ul = 1,
    vl = 1;
const uvData = new Float32Array([0, 0, ul, 0, ul, vl, ul, vl, 0, vl, 0, 0]);
...
const textureTest = async () => {
    ...
    // 创建并获取纹理
    const ts = await GetTexture(device, "brick.png");
    // 绑定Unifrom常量
